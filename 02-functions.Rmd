    ...
    - **The 3 Properties of Limits**
      ...
      - **The sum law of limits**
        ...
        - <details><summary>**Proof**</summary>
          ...
          - Consequently: 
            - $\forall \epsilon > 0, \exists \delta = \min(\delta_1, \delta_2) > 0, \text{s.t}, \forall x \in \mathbb{R}, 0 < |x - a| < \delta \implies 0 < |f(x) - l + g(x) - M| ≤ |f(x) - L| + |g(x) - M| < \frac{\epsilon}{2} + \frac{\epsilon}{2} < \epsilon \blacksquare$ </details>
      - **The multiplicative law of limits**
        ...
        - <\details><summary>**Proof**</summary>
          - Given that 
            - $\displaystyle \lim_{x \rightarrow a} = L \\ ~~~~~ \forall \epsilon > 0, \exists \delta > 0, \text{s.t}, \forall x \in \mathbb{R}, 0 < |x - a| < \delta \implies 0 < |f(x) - L| < \epsilon \\ \displaystyle \lim_{x \rightarrow a} = M \\ ~~~~~ \forall \epsilon > 0, \exists \delta > 0, \text{s.t}, \forall x \in \mathbb{R}, 0 < |x - a| < \delta \implies 0 < |g(x) - M| < \epsilon$
          - We are trying to prove:
            - $\displaystyle \lim_{x \rightarrow a}(f \times g)(x) = L \times M\\ ~~~~~  \forall \epsilon > 0, \exists \delta > 0, \text{s.t}, \forall x \in \mathbb{R}, 0 < |x - a| < \delta \implies 0 < |f(x) \times g(x) - L \times M| < \epsilon$
          - We can manipulate the last bit as
            - $\forall \epsilon > 0, \exists \delta > 0, \text{s.t}, \forall x \in \mathbb{R}, 0 < |x - a| < \delta \implies 0 < |f(x) \times g(x) - f(x)\times M + f(x)\times M - L \times M| < \epsilon$
          ...
          - We need to make the statement work by requiring each of the last two terms to be less than half of $\delta$:
            - $\displaystyle \begin{aligned} |f(x)| |g(x) - M| &< \frac{\epsilon}{2} \\ |M| |f(x) - L| &< \frac{\epsilon}{2}\end{aligned}$
          - We have to find a $\delta$ that make the statement work 
            - For the second term
              - To make 
              ...
              - Consequently, we have to find a $\delta$ for $L$ for this condition
                - $\displaystyle \lim_{x \rightarrow a}f(x) = L \\ \displaystyle ~~~~~ \forall \epsilon > 0, \exists \delta_1 > 0, \text{s.t}, \forall x \in \mathbb{R}, 0 < |x - a| < \delta_1 \implies 0 < |f(x) - L| < \frac{\epsilon}{2 \left[ |M| + 1\right]}$
            - For the first term 
              - To make
              ...
              - Consequently, we have to find a $\delta$ for this condition
                - $\displaystyle \lim_{x \rightarrow a} g(x) = M \\ \displaystyle ~~~~~ \forall \epsilon > 0, \exists \delta_2 > 0, \text{s.t}, \forall x \in \mathbb{R}, 0 < |x - a| < \delta_1 \implies 0 < |g(x) - L| < \frac{\epsilon}{2 |L| + \frac{\epsilon}{2 \left[ |M| + 1\right]}}$
